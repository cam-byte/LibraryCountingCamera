...
if (isset($_POST["import"]))
{
  ...
  if(in_array($_FILES["file"]["type"],$allowedFileType))
  {
                ...
                if(isset($Row[1]))
		{
                ...
                if (!empty($Month) || !empty($PeopleEntered))
                {
                    $query = "INSERT INTO AnnualReportData (Month, PeopleEntered) VALUES ('$Month','$PeopleEntered')";
...
<body>
    ...
    <div class="outer-container">
		...
		<h4>To be used ONLY to upload information for Annual Report Data</h4>
