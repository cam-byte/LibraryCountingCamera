      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php
           ...
           $maxtime = '';
           $mintime = '';
            $sql = "SELECT * FROM WeeklyReportDataExited";
...
<script type="text/javascript">
  ...
  <nav>
    ...
    <div class="dailyreportanalysis" style = "position:relative; left:250px; top:-600px;">
      ...
      <br>
      <?php $result = mysqli_query($conn,"SELECT MIN(NULLIF(PeopleExited,0)) AS min_people FROM WeeklyReportDataExited");
            $row = mysqli_fetch_array($result);
            $minpeople = $row['min_people'];
            $result2 = mysqli_query($conn,"SELECT DayOfWeek FROM WeeklyReportDataExited WHERE PeopleExited=$minpeople");
