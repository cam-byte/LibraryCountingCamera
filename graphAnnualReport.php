...
<script type="text/javascript">
  ...
  <nav>
    ...
    <div class="dailyreportanalysis" style = "position:relative; left:250px; top:-600px;">
      ...
      <?php $result = mysqli_query($conn,"SELECT MIN(NULLIF(PeopleEntered,0)) AS min_people FROM AnnualReportData");
            $row = mysqli_fetch_array($result);
            $minpeople = $row['min_people'];
            $result2 = mysqli_query($conn,"SELECT Month FROM AnnualReportData WHERE PeopleEntered=$minpeople");
