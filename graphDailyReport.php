...
<html>
  ...
  <h1 id="welcome">Hello, <i><?php echo $login_session; ?></i></h1>
  <h8><i>This is your traffic report dashboard</i></h8> <br> 
</br>
    ...
    <script type="text/javascript">
      ...
      function drawStuff() {
        var data = new google.visualization.arrayToDataTable([
          ...
          <?php 
          $sql = "SELECT * FROM DailyReportData";
...
<script type="text/javascript">
      ...
      function drawGaugeChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ...
          <?php 
            ...
            $result = mysqli_query($conn,$sql);
            while($row = mysqli_fetch_array($result)){
                    $peopleenter = $row['PeopleEntered'];
		        } ?>
          ['People Entered', <?php echo $peopleenter ?>]
        ]);
  ...
  <body>
      <div id="barchart_material" style="width: 900px; height: 500px; position:relative; left:800;"></div>
        <div class = "navMenu" style = "position:relative; left:1700px; top:-450px;" >
        <nav>
		      <ul id="mainMenu"style = "position:relative; top: -105px;">
      ...
      <div id="chart_div" style="width: 100px; height: 50px; position:relative; left:300px; top:-1000px;"></div>
      ...
      <br>
      <?php $result = mysqli_query($conn,"SELECT MIN(NULLIF(PeopleEntered,0)) AS min_people FROM DailyReportData");
            $row = mysqli_fetch_array($result);
            $minpeople = $row['min_people'];
            $result2 = mysqli_query($conn,"SELECT TimeEntered FROM DailyReportData WHERE PeopleEntered=$minpeople");
            $row2 = mysqli_fetch_array($result2);
            $mintime = $row2['TimeEntered'];
      ?>
