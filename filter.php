<?php  
 ...
 {  
      ...
      $output = '';  
      $query = "SELECT * FROM MonthlyReportData INNER JOIN MonthlyReportDataExited ON MonthlyReportData.DayOfMonth=MonthlyReportDataExited.DayOfMonth WHERE MonthlyReportData.DayOfMonth BETWEEN '".$_POST["from_date"]."' AND '".$_POST["to_date"]."'";  
    ...
    <script type="text/javascript">
      ...
      function drawStuff() {
        var data = new google.visualization.arrayToDataTable([
          ...
          <?php 
            $sql = "SELECT * FROM MonthlyReportData INNER JOIN MonthlyReportDataExited ON MonthlyReportData.DayOfMonth=MonthlyReportDataExited.DayOfMonth WHERE MonthlyReportData.DayOfMonth BETWEEN '".$_POST["from_date"]."' AND '".$_POST["to_date"]."'";
