  ...
  if(in_array($_FILES["file"]["type"],$allowedFileType))
  {
        ...
        for($i=0;$i<$sheetCount;$i++)
        {
            ...
            foreach ($Reader as $Row)
            {
                ...
                if(isset($Row[0])) 
		{
                    $TimeEntered = mysqli_real_escape_string($conn,$Row[0]);
                }
                $PeopleEntered = "";
                if(isset($Row[1]))
		{
                ...
                if (!empty($TimeEntered) || !empty($PeopleEntered))
                {
                    $query = "INSERT INTO DailyReportData (TimeEntered, PeopleEntered) VALUES ('$TimeEntered','$PeopleEntered')";
