<?php  
 ...
 {  
      ...
      $output = '';  
      $query = "SELECT * FROM WeeklyReportData INNER JOIN WeeklyReportDataExited ON WeeklyReportData.DayOfWeek=WeeklyReportDataExited.DayOfWeek WHERE WeeklyReportData.ID BETWEEN '".$_POST["from_day"]."' AND '".$_POST["to_day"]."'"; 
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta/js/bootstrap.min.js" integrity="sha384-h0AbiXch4ZDo7tp9hKZ4TsHbi047NrKGLO3SEJAg45jXxnGIfYzk4Si90RDIqNm1" crossorigin="anonymous"></script>
      ...
      function drawStuff() {
        var data = new google.visualization.arrayToDataTable([
          ...
          <?php 
          $sql = "SELECT * FROM WeeklyReportData INNER JOIN WeeklyReportDataExited ON WeeklyReportData.DayOfWeek=WeeklyReportDataExited.DayOfWeek WHERE WeeklyReportData.ID BETWEEN '".$_POST["from_day"]."' AND '".$_POST["to_day"]."'"; 
